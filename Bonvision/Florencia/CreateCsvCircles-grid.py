...
filePath = r"C:\Users\LABadmin\Documents\GitHub\ExperimentalProtocols\Bonvision\Florencia\grid.csv"
...
yRange = np.arange(-20, 50, gridSize)  # np.arange(-41,41,5)#np.arange(-41,41,10)
diaRange = [16]  # [1,4,16,255]
blackWhiteRange = [0, 1] 
presentationT = 1
